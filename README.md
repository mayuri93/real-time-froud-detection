...
📄 Contents:
system_architecture.png A visual overview of the federated learning setup, showing communication flow between the central coordinator and distributed clients.

project_slide_deck.md A markdown-formatted slide deck summarizing the project purpose, challenges, architecture, results, and contributions by Mayuri .
